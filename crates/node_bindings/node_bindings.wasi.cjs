...
let __wasmFilePath = __nodePath.join(__dirname, 'node_bindings.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'node_bindings.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  try {
    __wasmFilePath = __nodePath.resolve('fast-magic-string-wasm32-wasi')
  } catch {
    throw new Error('Cannot find node_bindings.wasm32-wasi.wasm file, and fast-magic-string-wasm32-wasi package is not installed.')
  }
}
...
module.exports.JsMagicString = __napiModule.exports.JsMagicString
