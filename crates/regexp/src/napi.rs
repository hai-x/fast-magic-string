// https://github.com/web-infra-dev/rspack/blob/main/crates/rspack_regex/src/napi.rs
...
impl ValidateNapiValue for FmsRegex {}

impl TypeName for FmsRegex {
...
impl FromNapiValue for FmsRegex {
